...
execute if entity @e[tag=start3,tag=mianstart] run say 背包惩罚已开启
execute unless entity @e[tag=start3,tag=mianstart] run say 背包惩罚未开启
execute if entity @e[tag=newset,tag=mianstart] run say 新手辅助已开启
execute unless entity @e[tag=newset,tag=mianstart] run say 新手辅助未开启
execute if entity @e[tag=tpon,tag=mianstart] run say 传送辅助已开启
execute unless entity @e[tag=tpon,tag=mianstart] run say 传送辅助未开启
execute if entity @e[tag=ookon,tag=mianstart] run say 一键挖掘已开启
execute unless entity @e[tag=ookon,tag=mianstart] run say 一键挖掘未开启
...
tellraw @s [{"text":"移除设定，关闭主程序","color":"green","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false,"clickEvent":{"action":"run_command","value":"/kill @e[tag=mianstart]"}}]
