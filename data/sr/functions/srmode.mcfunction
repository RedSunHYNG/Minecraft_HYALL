...
#残·魔剑阿波菲斯
execute if entity @a[nbt={Inventory:[{tag:{Tags:["srwq_abfs"]},Slot:-106b}]}] run summon minecraft:armor_stand ~ ~ ~ {Tags:["abfs","sr_tst"],Invisible:1b,Marker:1b}
...
#僵尸刷怪笼
execute as @a[nbt={Inventory:[{tag:{Tags:["srwq_sum_zom"]},Slot:-106b}]}] at @s run summon minecraft:armor_stand ~ ~1 ~ {Invulnerable:1b,NoGravity:1b,Invisible:1b,Small:1b,Rotation:[0f,0f],Tags:["srwq_sum_zom","srwq_sum_tst"]}
...
#骷髅刷怪笼
execute as @a[nbt={Inventory:[{tag:{Tags:["srwq_sum_c"]},Slot:-106b}]}] at @s run summon minecraft:armor_stand ~ ~1 ~ {Invulnerable:1b,NoGravity:1b,Invisible:1b,Small:1b,Rotation:[0f,0f],Tags:["srwq_sum_c","srwq_sum_tst"]}
...
#蜘蛛刷怪笼
execute as @a[nbt={Inventory:[{tag:{Tags:["srwq_sum_z"]},Slot:-106b}]}] at @s run summon minecraft:armor_stand ~ ~1 ~ {Invulnerable:1b,NoGravity:1b,Invisible:1b,Small:1b,Rotation:[0f,0f],Tags:["srwq_sum_z","srwq_sum_tst"]}
...
#铁傀儡刷怪笼
execute as @a[nbt={Inventory:[{tag:{Tags:["srwq_sum_i"]},Slot:-106b}]}] at @s run summon minecraft:armor_stand ~ ~1 ~ {Invulnerable:1b,NoGravity:1b,Invisible:1b,Small:1b,Rotation:[0f,0f],Tags:["srwq_sum_i","srwq_sum_tst"]}
...
#苦力怕刷怪笼
execute as @a[nbt={Inventory:[{tag:{Tags:["srwq_sum_cre"]},Slot:-106b}]}] at @s run summon minecraft:armor_stand ~ ~1 ~ {Invulnerable:1b,NoGravity:1b,Invisible:1b,Small:1b,Rotation:[0f,0f],Tags:["srwq_sum_cre","srwq_sum_tst"]}
...
#村民刷怪笼
execute as @a[nbt={Inventory:[{tag:{Tags:["srwq_sum_v"]},Slot:-106b}]}] at @s run summon minecraft:armor_stand ~ ~1 ~ {Invulnerable:1b,NoGravity:1b,Invisible:1b,Small:1b,Rotation:[0f,0f],Tags:["srwq_sum_v","srwq_sum_tst"]}
execute as @a[nbt={Inventory:[{tag:{Tags:["srwq_sum_v"]},Slot:-106b}]}] at @s run item replace entity @s weapon.offhand with minecraft:air 1
...
#净化圣师
execute as @e[type=minecraft:villager,tag=tst,tag=srwq_jhss] at @s run scoreboard players set @e[distance=..4,scores={monster_time=1..15},tag=grt] monster_time 0

#抗毒血清
execute as @a[nbt={Inventory:[{tag:{Tags:["srwq_kdxq"]},Slot:-106b}]}] at @s run tag @e[distance=..3] remove byt
execute as @a[nbt={Inventory:[{tag:{Tags:["srwq_kdxq"]},Slot:-106b}]}] at @s as @e[nbt={CustomName:'{"text":"变异体"}'},distance=..3] at @s run data modify entity @s CustomName set value '{"text":" "}'
execute as @a[nbt={Inventory:[{tag:{Tags:["srwq_kdxq"]},Slot:-106b}]}] at @s run item replace entity @s weapon.offhand with minecraft:air 1
