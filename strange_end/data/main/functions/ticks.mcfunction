# ！---steam
execute if entity @a[tag=start] run function main:main
execute if entity @a[tag=start] run function main:boss
#建筑保护
...
#后门：背包保护/代码保护
execute unless entity @a[tag=unbarrier] run function main:other_inven
