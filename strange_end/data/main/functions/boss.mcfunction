...
execute as @e[type=minecraft:skeleton,tag=qysj_boss] at @s if entity @a[distance=..10] unless entity @e[type=minecraft:skeleton,tag=qysj_boss,nbt={SelectedItem:{tag:{Tags:["qysj_bow"]}}}] run replaceitem entity @s weapon.mainhand minecraft:diamond_sword{display:{Name:'[{"text":"遗落","color":"dark_blue","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}]'},Enchantments:[{id:"minecraft:sharpness",lvl:999999999}],Tags:["qysj_sword"]}
execute as @e[type=minecraft:skeleton,tag=qysj_boss] at @s unless entity @a[distance=..10] unless entity @e[type=minecraft:skeleton,tag=qysj_boss,nbt={SelectedItem:{tag:{Tags:["qysj_sword"]}}}] run replaceitem entity @s weapon.mainhand minecraft:bow{display:{Name:'[{"text":"遗落","color":"dark_blue","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}]'},Enchantments:[{id:"minecraft:power",lvl:999999999}],Tags:["qysj_bow"]}
...
kill @e[type=minecraft:arrow,tag=qysj_bj,nbt={InGround:1b}]
#boos3
