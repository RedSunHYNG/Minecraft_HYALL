...
#复活娃娃:3
execute if entity @e[tag=bossskill_c,scores={bossskill=3}] run summon minecraft:zombie ~ ~1 ~ {CustomName:"[{\"text\":\"复活娃娃\",\"color\":\"red\",\"bold\":false,\"italic\":false,\"underlined\":false,\"strikethrough\":false,\"obfuscated\":false}]",Tags:["timeboss","spawboss","sr_tst"],NoAI:1b,IsBaby:1b}
execute if entity @e[tag=bossskill_c,scores={bossskill=3}] run say 消灭复活娃娃以防止boss回复命数。
#强化体:3
...
kill @e[tag=timetable_5,scores={timer=1200..}]